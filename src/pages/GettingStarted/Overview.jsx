    ...
    <div>
      <Container p='0 12px'>
          ...
          <ul className="list">
            <li className="pl-12 fz-16 line-height-36">
              <span>
                ...
                Over 2,500 open-source contributors have poured countless hours into these components. Focus on your
                core business logic instead of reinventing the wheel—we've got your UI covered.
              </span>
            </li>
            <li className="pl-12 fz-16 line-height-36">
              <span>
            ...
            <li className="pl-12 fz-16 line-height-36">
              <span>
                ...
                My UI has the largest UI community in the React ecosystem. It's almost as old as React itself—its
                history stretches back to 2014—and we're in this for the long haul. You can count on community's support
                for years to come (e.g. Stack Overflow).
              </span>
            </li>
          </ul>
        </Section>
        <Section className="pt-24">
          ...
          <p className="pl-12 fz-16 line-height-36">
            MUI Base, by contrast, could be considered the "skeletal" or "headless" counterpart to My UI—in fact, My UI
            v6 will use MUI Base components and hooks for its foundational structure.
          </p>
        </Section>
      </Container>
    </div>
